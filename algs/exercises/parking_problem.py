...
#
r"""
Exercise 3.4.43 Parking Problem. Test hypothesis that the total cost to insert
*M* random keys into a table of size *M* is:

.. math:: `\sim \sqrt{\frac{\pi}{2}} M^{3/2}`
"""
# =============================================================================
...
# Theory curve
ax.plot(ms, th_cost(ms), 'C3-',
        label=r'$\sqrt{\frac{\pi}{2}} M^{3/2}$')

# Fit curve
ax.plot(ms, fit_costs(ms, *popt), 'C0-',
        label=rf"${popt[0]:.2g} M^{{{popt[1]:.3g}}}$")
# Error bounds
...
ax.set(xlabel='M',
       ylabel='Total Cost of Inserting M Keys',
