...
"""Exercise 3.5.24: Non-overlapping interval search for a point.

Given a list of non-overlapping intervals, find which one contains the query
point.
...
class IntervalSearch:
    """Search for the interval containing a query point among a list of
